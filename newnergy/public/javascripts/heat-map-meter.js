	$(function () {
		...
		var startMonth = document.getElementById("startMonth").innerHTML;
		var startDay = document.getElementById("startDay").innerHTML;
		var endYear = document.getElementById("endYear").innerHTML;
		var endMonth = document.getElementById("endMonth").innerHTML;
	    ...
	    $('#heatmap_container').highcharts({
	        ...
	        xAxis: {
	            type: 'datetime',
	            min: Date.UTC(startYear,startMonth,startDay),
	            max: Date.UTC(endYear,endMonth,endDay),
	            labels: {
	                align: 'left',
	                x: 5,
	                y: 14,
